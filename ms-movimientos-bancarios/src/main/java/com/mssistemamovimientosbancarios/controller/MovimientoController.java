...
public class MovimientoController {
	...
	@Operation(summary = "Consulta los movimientos registrados en el sistema de movimientos bancarios.")
	@ApiResponses(value = {
	...
	public GenericBooleanResponse getMovimientos() {	
		log.info("Ingresando al controlador de movimiento getMovimientos() metodo.");
		List<Movimiento> response = movimientoService.getMovimientos();
		log.info("Finalizando entrada al controlador de movimiento getMovimientos() metodo.");
	...
	@Operation(summary = "Registra un movimiento en el sistema de movimientos bancarios.")
    @ApiResponses(value = {
    ...
    @ResponseStatus(HttpStatus.OK)
    public GenericBooleanResponse registrarMovimiento(@Valid @RequestBody  MovimientoRequest movimientoRequest) {
        log.info("Inicio de proceso para registrar un movimiento. registrarMovimiento, MovimientoRequest: {} ", movimientoRequest);
        return movimientoService.registrarMovimiento(movimientoRequest);
    }
